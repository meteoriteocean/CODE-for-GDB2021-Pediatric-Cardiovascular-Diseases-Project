...
calculate = function(json) {
  ...
  graphs = c('AgeDeviations',
             ...
             'PeriodRR',
             'CohortRR',
             'LocalDrifts') # To retrieve fitted rate data
  ...
  ## Generate keyinfo
  results[['info']] = input$description
  ...
  ## Retrieve fitted rate data
  results[['FittedRates']] = output[['FittedRates']]
  #results[['apcModel']] = output[['APCModel']]
  #results[['designM']] = output[['Matrices']]
  #results[['Inputs']] = output[['Inputs']]
